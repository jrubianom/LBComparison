...
void LatticeBoltzmann::Print(ofstream &fileAmpl, ofstream &fileError,ofstream &fileMem,int i){
  ...
  fileMem <<  abs(100*(Ertheo - Er)/Ertheo) << "\t" << abs(100*(Ettheo - Et)/Ettheo) << "\t" << sizeof(vector3D)*fs_size/1024 << endl;
